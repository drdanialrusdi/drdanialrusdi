...
def main(argPars):
    ...
    parser.add_argument('-s', '--search', default='Rastrelliger kanagurta', type=str, help='search term')
    parser.add_argument('-n', '--num_images', default=100, type=int, help='num images to save')
    parser.add_argument('-d', '--directory', default='D:/My Documents/2018/Pasar/Pelaling', type=str, help='save directory')
